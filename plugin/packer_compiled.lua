...
vim.cmd [[au BufWinEnter * ++once lua require("packer.load")({'nvim-treesitter', 'alpha-nvim', 'gitsigns.nvim', 'which-key.nvim', 'toggleterm.nvim'}, { event = "BufWinEnter *" }, _G.packer_plugins)]]
