...
vim.cmd [[au BufWinEnter * ++once lua require("packer.load")({'bufferline.nvim', 'lualine.nvim', 'which-key.nvim', 'yuck.vim', 'nvim-treesitter'}, { event = "BufWinEnter *" }, _G.packer_plugins)]]
