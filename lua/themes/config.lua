...
M.highlights_base = function(colors)
  return {
    ...
    StalineLspHints = { bg = colors.background, fg = colors.color6 },
    StalineLspWarning = { bg = colors.background, fg = colors.color11 },
    StalineLspErrorIcon = { bg = colors.background, fg = colors.color9 },
    StalineLspInfoIcon = { bg = colors.background, fg = colors.color12 },
    StalineLspHintsIcon = { bg = colors.background, fg = colors.color6 },
    StalineLspWarningIcon = { bg = colors.background, fg = colors.color11 },
