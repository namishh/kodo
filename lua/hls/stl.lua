...
return {
  ...
  StalineFolderTextMinimal = { bg = colors.background, fg = colors.color7 },

  StalineFilename = { bg = colors.background, fg = colors.color7 },
  StalineFilenameMinimal = { bg = colors.background, fg = colors.color7 },
  ...
  StalineProgressMinimal = { bg = utils.lighten(colors.cursorline, colors.foreground, 0.93), fg = colors.color7 },
  StalineModeMinimal = { bg = utils.lighten(colors.cursorline, colors.foreground, 0.93), fg = colors.color7 },
  ...
  StalineSep = { bg = colors.background, fg = colors.comment },
  StalineNix = { bg = colors.background, fg = colors.color12 },
  ...
  StalineLspNameMinimal = { bg = colors.background, fg = colors.color7 },
  ...
  StalineDiffAddMinimal = { bg = colors.black, fg = colors.comment },
  StalineDiffChange = { bg = colors.background, fg = colors.color11 },
  StalineDiffChangeFancy = { bg = utils.darken(colors.color11, colors.black, 0.07), fg = colors.foreground },
  StalineDiffChangeMinimal = { bg = colors.black, fg = colors.comment },
  StalineDiffRemoveFancy = { bg = colors.black, fg = colors.color9 },
  StalineDiffRemoveMinimal = { bg = colors.black, fg = colors.comment },
