...
table.insert(footer, 2, emptyLine)
...
M.open = function()
  ...
  local headerStart = math.floor((vim.api.nvim_win_get_height(0) / 2) - (#dashboard / 2))
  local start = math.floor((vim.api.nvim_win_get_height(0) / 2) - (#dashboard / 2))
